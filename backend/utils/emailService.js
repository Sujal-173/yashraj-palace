...
const FOOTER = `
  <div style="background:#F2EDE4;padding:16px;text-align:center">
    ...
    <p style="margin:4px 0 0;color:#8A8480;font-size:11px">📞 +91 70000 00000 · 💬 <a href="https://wa.me/917000000000" style="color:#6B1A2B">WhatsApp</a></p>
  </div>`;
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;border:1px solid #eee;border-radius:8px;overflow:hidden">
    ...
    <div style="padding:28px">
      ...
      <div style="background:#FFF9EE;border:1px solid #C9A84C;border-radius:6px;padding:14px;margin:20px 0">
        ...
        <p style="margin:4px 0 0;color:#4A4A4F;font-size:14px">📞 +91 70000 00000</p>
      </div>
    </div>
    ${FOOTER}
  </div>`;
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;border:1px solid #eee;border-radius:8px;overflow:hidden">
    ...
    <div style="padding:28px">
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0">
        ...
        ${reason ? `<tr><td style="padding:10px;font-weight:bold;color:#6B1A2B">Reason</td><td style="padding:10px">${reason}</td></tr>` : ''}
...
const sendAdminNewBookingAlert = async (booking) => {
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;border:1px solid #eee;border-radius:8px;overflow:hidden">
    ...
    <div style="padding:28px">
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0">
        <tr style="background:#FAF7F2"><td style="padding:10px;font-weight:bold;color:#6B1A2B;width:40%">Booking ID</td><td style="padding:10px">${booking.bookingId}</td></tr>
        <tr><td style="padding:10px;font-weight:bold;color:#6B1A2B">Guest</td><td style="padding:10px">${booking.guestDetails?.name}</td></tr>
...
const sendAdminNewEventAlert = async (booking) => {
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;border:1px solid #eee;border-radius:8px;overflow:hidden">
    ...
    <div style="padding:28px">
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0">
        <tr style="background:#FAF7F2"><td style="padding:10px;font-weight:bold;color:#6B1A2B;width:40%">Inquiry ID</td><td style="padding:10px">${booking.bookingId}</td></tr>
        <tr><td style="padding:10px;font-weight:bold;color:#6B1A2B">Contact</td><td style="padding:10px">${booking.contactDetails?.name}</td></tr>
